...
export const productVariants: IProductVariant[] = [
  {
    ...
    // variantId: "variant-1",
    sizeAspectId: "size_xs",
    colorAspectId: "color_red",
    countInStock: 10,
    sku: "SKU-123",
    price: 100,
    discountPrice: 90
  ...
  },
  {
    ...
    // variantId: "variant-5",
    sizeAspectId: "size_xl",
    colorAspectId: "color_black",
    countInStock: 50,
    sku: "SKU-345",
    price: 180,
    discountPrice: 150
